...
dependencies:
  p5-svelte:
    specifier: ^3.1.2
    version: 3.1.2(@types/p5@1.7.6)(p5@1.9.0)
...
packages:
  ...
  /p5-svelte@3.1.2(@types/p5@1.7.6)(p5@1.9.0):
    resolution: {integrity: sha512-lcfWh+cJ1/wRdIXHnjpYmDgj2h3TCy1QJVQnf/cBcFWS8CSkvyAN5F8u8H2U8qBUtZ4XaD3nd+1NoYUMHaMExQ==}
    peerDependencies:
      '@types/p5': ^1.4.2
      p5: ^1.4.0
    dependencies:
  ...
  /p5@1.9.0:
    resolution: {integrity: sha512-+5/hz0ZokCDf7BMMAeemE7FIo7gFZK7ImL62acHLXZwerGjqj+171bnaAWj4aCFCx6fwysAr2U7/AKuPyPhehA==}
    dev: false
  ...
  /svelte-check@3.6.3(svelte@4.2.9):
    ...
    dependencies:
      ...
      sade: 1.8.1
      svelte: 4.2.9
      svelte-preprocess: 5.1.3(svelte@4.2.9)(typescript@5.3.3)
      typescript: 5.3.3
    transitivePeerDependencies:
      - '@babel/core'
      - coffeescript
