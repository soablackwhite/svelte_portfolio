...
var Tokenizer = class {
  ...
  findWsEnd(pos) {
    for (; pos < this.str.length; pos++) {
      ...
      if (code2 !== R && code2 !== N2 && code2 !== F && code2 !== SPACE && code2 !== TAB) {
        break;
      }
    }
    return pos;
...
function parse2() {
  ...
  if (this.tokenType === Number2) {
    ...
    expectCharCode.call(this, i - this.tokenStart, N4);
...
//# sourceMappingURL=chunk-C3ZVJJF6.js.map
